...
var SwitchOn = React.createClass({
  ...
  render: function() {
    var width    = this.props.width || this.props.height;
    var height   = this.props.height || this.props.width;
